export const _MAX_VIDEO_SIZE = 500 * 1024 * 1024;
export const _MAX_THUMBNAIL_SIZE = 10 * 1024 * 1024;
...
export const _visibilities: Visibility[] = ["public", "private"];
...
export const _initialVideoState = {
  isLoaded: false,
...
export const _infos = ["transcript", "metadata"];

export const _DEFAULT_VIDEO_CONFIG = {
  width: { ideal: 1920 },
  height: { ideal: 1080 },
  frameRate: { ideal: 30 },
};

export const _DEFAULT_RECORDING_CONFIG = {
